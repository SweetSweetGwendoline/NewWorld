...
|:---|:---|:---:|:---:|:---:|
| `Armoring 0` | [Coarse Leather Adventurer's Satchel (Tier II)](https://nwdb.info/db/recipe/Procedural_BagAT2) | `5`-`10` | +100 | [Minor Rune of Holding (Tier II)](https://nwdb.info/db/item/HoldingRuneT2)<br/>*(1000 Token and 250 Gold)* |
| `Armoring 50` | [Rugged Leather Adventurer's Satchel (Tier III)](https://nwdb.info/db/recipe/Procedural_BagAT3) | `15`-`20` | +150 | [Major Rune of Holding (Tier III)](https://nwdb.info/db/item/HoldingRuneT3)<br/>*(3000 Token and 500 Gold)* |
| `Armoring 100` | [Layered Leather Adventurer's Satchel (Tier IV)](https://nwdb.info/db/recipe/Procedural_BagAT4) | `35`-`40` | +225 | [Greater Rune of Holding (Tier IV)](https://nwdb.info/db/item/HoldingRuneT4)<br/>*(5000 Token and 1000 Gold)* |
| `Armoring 150` | [Infused Leather Adventurer's Satchel (Tier V)](https://nwdb.info/db/recipe/Procedural_BagAT5) | `55`-`60` | +300 | [Grand Rune of Holding (Tier V)](https://nwdb.info/db/item/HoldingRuneT5)<br/>*(7500 Token and 1500 Gold)* |
...
> | Gathering | Resource |
> |:---|:---|
> | Level 30 Harvesting<br/>Level 10 Mining | 3 [Rivercress Stem](https://nwdb.info/db/item/RivercressT1)<br/>3 [Petalcap](https://nwdb.info/db/item/PetalcapT1)<br/>5 [Silver Ingot](https://nwdb.info/db/item/IngotPreciousT1) |
...
>
> - [Bones For Barkimedes (Expedition)](https://nwdb.info/db/quest/0699_0103_BarkimedesPup) Amarine Excavation (`25`) 
...
|:---:|:---:|:---:|:---:|
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/fort_elite.png" alt="Deadman's Cove" width="40px"/> | `25` | **Deadman's Cove** | Cutlass Keys |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/abandoned_village_elite.png" alt="Brightwood Isle" width="40px"/> | `34` | **Brightwood Isle** | Brightwood |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/cave_elite.png" alt="Stone Skull Fort" width="40px"/> | `40` | **Stone Skull Fort** | Cutlass Keys |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/abandoned_village_elite.png" alt="Periville" width="40px"/> | `40` | **Periville** | Weaver's Fen |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_lighthouse_elite.png" alt="Eridanus" width="40px"/> | `46` | **Eridanus** | Restless Shore |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_lighthouse_elite.png" alt="Scorpius" width="40px"/> | `50` | **Scorpius** | Mourningdale |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/military_camp_elite.png" alt="Svikin's Stand" width="40px"/> | `50` | **Svikin's Stand** | Great Cleave |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_temple_sm_elite.png" alt="Stranglepitch Road" width="40px"/> | `60` | **Stranglepitch Road** | Great Cleave |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_temple_sm_elite.png" alt="Balebane Maw" width="40px"/> | `60` | **Balebane Maw** | Great Cleave |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_temple_sm_elite.png" alt="Dead Fool's Pass" width="40px"/> | `60` | **Dead Fool's Pass** | Great Cleave |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_temple_sm_elite.png" alt="Mangled Pox Gate" width="40px"/> | `60` | **Mangled Pox Gate** | Great Cleave |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_shrine_elite.png" alt="Nihilo Visage" width="40px"/> | `60` | **Nihilo Visage** | Great Cleave |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/fort_elite.png" alt="Caminus" width="40px"/> | `61` | **Caminus** | Shattered Mountain |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_temple_sm_elite.png" alt="Imperial Palace" width="40px"/> | `61`-`62` | **Imperial Palace** | Ebonscale Reach |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/ancient_malevolence_elite.png" alt="Malevolence" width="40px"/> | `62` | **Malevolence** | Edengrove |
...
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/expeditions/graveyard_elite.png" alt="Myrkgard Cathedral" width="40px"/> | `63`-`65` | **Myrkgard Cathedral** | Shattered Mountain |
...
|   | Gem | Weapon | Armor |
|---|:---|:---|:---|
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/gems/ambercutt4.png" alt="Cut Pristine Amber" width="40px"/> | [Cut Pristine Amber](https://nwdb.info/db/item/AmberCutT4) | [Arboreal IV](https://nwdb.info/db/perk/PerkID_Gem_NatureDMG4)<br/>*50% of damage is converted to Nature.<br/>Damage scales off base weapon stat or FOC, whichever is higher.* | [Nature Ward IV](https://nwdb.info/db/perk/PerkID_Gem_NatureWard4)<br/>*+3.8% Nature Damage Absorption.* |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/gems/amethystcutt4.png" alt="Cut Pristine Amethyst" width="40px"/> | [Cut Pristine Amethyst](https://nwdb.info/db/item/AmethystCutT4) | [Abyssal IV](https://nwdb.info/db/perk/PerkID_Gem_VoidDMG4)<br/>*50% of damage is converted to Void.<br/>Damage scales off base weapon stat or INT, whichever is higher.* | [Abyssal Ward IV](https://nwdb.info/db/perk/PerkID_Gem_AbyssalWard4)<br/>*+6% Void Damage Absorption.* |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/gems/aquamarinecutt4.png" alt="Cut Pristine Aquamarine" width="40px"/> | [Cut Pristine Aquamarine](https://nwdb.info/db/item/AquamarineCutT4) | [Frozen IV](https://nwdb.info/db/perk/PerkID_Gem_IceDMG4)<br/>*50% of damage is converted to Ice.<br/>Damage scales off base weapon stat or INT, whichever is higher.* | [Ice Ward IV](https://nwdb.info/db/perk/PerkID_Gem_IceWard4)<br/>*+3.8% Ice Damage Absorption.* |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/gems/rubycutt4.png" alt="Cut Pristine Ruby" width="40px"/> | [Cut Pristine Ruby](https://nwdb.info/db/item/RubyCutT4) | [Ignited IV](https://nwdb.info/db/perk/PerkID_Gem_FireDMG4)<br/>*50% of damage is converted to Fire.<br/>Damage scales off base weapon stat or INT, whichever is higher.* | [Fire Ward IV](https://nwdb.info/db/perk/PerkID_Gem_FireWard4)<br/>*+3.8% Fire Damage Absorption.* |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/gems/sapphirecutt4.png" alt="Cut Pristine Sapphire" width="40px"/> | [Cut Pristine Sapphire](https://nwdb.info/db/item/SapphireCutT4) | [Empowered IV](https://nwdb.info/db/perk/PerkID_Gem_ArcaneDMG4)<br/>*50% of damage is converted to Arcane.<br/>Damage scales off base weapon stat or INT, whichever is higher.* | [Arcane Ward IV](https://nwdb.info/db/perk/PerkID_Gem_ArcaneWard4)<br/>*+3.8% Arcane Damage Absorption.* |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/gems/topazcutt4.png" alt="Cut Pristine Topaz" width="40px"/> | [Cut Pristine Topaz](https://nwdb.info/db/item/TopazCutT4) | [Electrified IV](https://nwdb.info/db/perk/PerkID_Gem_LightningDMG4)<br/>*50% of damage is converted to Lightning.<br/>Damage scales off base weapon stat or INT, whichever is higher.* | [Lightning Ward IV](https://nwdb.info/db/perk/PerkID_Gem_LightningWard4)<br/>*+3.8% Lightning Damage Absorption.* |
|  |  |  |  |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/gems/diamondcutt4.png" alt="Cut Pristine Diamond" width="40px"/> | [Cut Pristine Diamond](https://nwdb.info/db/item/DiamondCutT4) | [Rally IV](https://nwdb.info/db/perk/PerkID_Gem_RallyGem4)<br/>*+15% damage and outgoing healing while at full health.* | [Wilderness Ward IV](https://nwdb.info/db/perk/PerkID_Gem_WildernessWard4)<br/>*1.9% Physical and 0.63% Elemental Damage Absorption.* |
| <img src="https://github.com/SweetSweetGwendoline/NewWorld/blob/main/img/gems/carneliancutt4.png" alt="Cut Pristine Carnelian" width="40px"/> | [Cut Pristine Carnelian](https://nwdb.info/db/item/CarnelianCutT4) | [Taunting IV](https://nwdb.info/db/perk/PerkID_Gem_ThreatAdd4)<br/>*Taunts are active. You generate +300% more threat.* | [Calming IV](https://nwdb.info/db/perk/PerkID_Gem_ThreatSub4)<br/>*You generate 10% less threat.* |
